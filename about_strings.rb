...
It was the worst of times.
	...
	helper = "\nIt was the best of times,\nIt was the worst of times.\n"
    assert_equal helper.length, long_string.length
    assert_equal helper.lines.count, long_string.lines.count
    assert_equal "\n", long_string[0,1]
  end
...
It was the worst of times.
EOS
	helper = "It was the best of times,\nIt was the worst of times.\n"
    assert_equal helper.length, long_string.length
    assert_equal helper.lines.count, long_string.lines.count
